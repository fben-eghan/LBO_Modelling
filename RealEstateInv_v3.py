...
# Create an array of results from running the simulation multiple times
results = np.array([RealEstateInvestment().calculate(num_sims=num_sims) for _ in range(num_sims)])

# Create a histogram and kernel density estimate of the results
